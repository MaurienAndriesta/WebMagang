            ...
            <div class="card-body">
                ...
                <div class="inner-card">  <!-- Inner card added here -->
                    <div class="d-flex justify-content-between mb-3">
                        <form method="GET" action="{{ route('penilaian.index') }}" class="d-flex">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="center-text">{{ $penilaian->bobot }}</td>
                        <td>
                            {{ $penilaian->kategori }}
                    ...
                    <div class="modal fade" id="editModal{{ $penilaian->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="bobot" class="form-control" step="0.01"
                                                value="{{ $penilaian->bobot }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="kategori" class="form-label">Kategori</label>
                                            <select name="kategori" class="form-control" required>
                                                <option value="Kriteria Penilaian"
                                                    {{ $penilaian->kategori == 'Kriteria Penilaian' ? 'selected' : '' }}>
                                                    Kriteria Penilaian</option>
                                                <option value="Penilaian Kedisiplinan"
                                                    {{ $penilaian->kategori == 'Penilaian Kedisiplinan' ? 'selected' : '' }}>
                                                    Penilaian Kedisiplinan</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kategori" class="form-control" required>
                                ...
                                <option value="Penilaian Kedisiplinan">Penilaian Kedisiplinan</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
