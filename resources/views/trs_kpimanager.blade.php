                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[0][nilai_spv]" min="1" max="5" readonly>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[0][nilai_manager]" min="1" max="5" >
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[1][nilai_spv]" min="1" max="5" readonly>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[1][nilai_manager]" min="1" max="5">
                                    </td>
                                    <td class="text-center"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[2][nilai_spv]" min="1" max="5" readonly>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[2][nilai_manager]" min="1" max="5">
                                    </td>
                                    <td class="text-center"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[3][nilai_spv]" min="1" max="5" readonly>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[3][nilai_manager]" min="1" max="5">
                                    </td>
                                    <td class="text-center"></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">20</td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[4][nilai_spv]" min="1" max="5" readonly>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm" name="items[4][nilai_manager]" min="1" max="5">
                                    </td>
                                    <td class="text-center"></td>
                                    <td></td>
                                </tr>
